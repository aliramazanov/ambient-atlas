...
/** Sub-classification of the anthropogenic tier into five scientifically distinct groups.
This is a pure function of the zone (no external data), so it is computed at runtime rather than generated:
keyword rules plus a reviewed override list for the cases the keywords get wrong.
Results are memoized by id. */

export type AnthroSub =
  | "nuclear"
  | "mining"
  | "fossil"
  | "industrial"
...
const OVERRIDE: Record<string, AnthroSub> = {
  ...
  "louisiana-cancer-alley": "industrial",
  "loudoun-data-center-alley": "industrial",
  "the-dalles-data-center": "industrial",
  "santiago-data-center-water": "industrial",
  "aragon-data-center-water": "industrial",
  "thor-chemicals-cato-ridge": "industrial",
  "oak-ridge-y12-mercury": "industrial",
  "chlorpyrifos-chamacos-salinas": "industrial",
  "uk-op-sheep-dip": "industrial",
  "gulf-war-illness-khamisiyah": "industrial",
  "alang-sosiya-shipbreaking": "waste",
  "sitakunda-shipbreaking-belt": "waste",
  "gadani-shipbreaking-yard": "waste",
  "tropodo-bangun-dioxin-eggs": "waste",
  "koko-toxic-waste-dump": "waste",
  "spanish-toxic-oil-syndrome": "industrial",
  "meknes-morocco-oil-1959": "industrial",
  "aerotoxic-bae146-australia": "industrial",
  "jamaica-ginger-jake-leg": "industrial",
  "manfredonia-enichem-arsenic-1976": "industrial",
  "bagnoli-italsider-brownfield": "industrial",
  "brofiscin-quarry-monsanto-dioxin": "waste",
  "stocamine-wittelsheim-buried-waste": "waste",
  "azf-toulouse-explosion-legacy": "industrial",
  "aliaga-shipbreaking-yards": "waste",
  "ergene-river-basin-thrace": "industrial",
  "iskenderun-bay-isdemir-steel": "industrial",
  "gemlik-gulf-industrial": "industrial",
...
function classify(z: Zone): AnthroSub {
  ...
  if (/e-?waste|\bwaste\b|\bdump\b|landfill|garbage|open burning/.test(t)) {
    return "waste";
  }
